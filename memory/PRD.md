...
## Backlog
- **Brand Review form + Hamburger menu rebrand (Jun 2026)**: Both now fully on Paper Hoof palette. BrandReviewForm: Mane Orange primary submit button (hover → Horse Black), Mane Orange input focus rings, orange cancel/close hovers, Horse Black modal scrim on Sheep White modal. HamburgerMenu: Sheep White overlay, Anton nav items, Mane Orange hovers on nav/social/email links. (They already inherited the global token remap; this added the orange accent layer.)
